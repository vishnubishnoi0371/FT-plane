...
const OurFeature = () => {
  ...
  return (
    <div className="max-w-[1200px] px-3 mx-auto pb-[50px]  xl:mt-[-30px] ">
      ...
      <div className="flex flex-row items-center justify-center flex-wrap   -mx-3 ">
        {mycard.map((obj, index) => (
          <div
            ...
            } md:w-1/3 lg:w-1/4 xxs:w-1/2 px-3`}
          >
            <div className="px-[15px] sm:px-[21px] py-[25px] sm:py-[42px] mt-5  bg-[#fff] rounded-[110px] sm:rounded-[185px] shadow-btn_sh_2 md:hover:scale-[110%] duration-300">
              ...
              <p
                className={`${
                  obj.name === "" ? "" : ""
                } text-center font-ff-mon text-nowrap font-extrabold text-[#030522] leading-[36px] not-italic text-2xl sm:pt-[32px] pb-[10px] `}
              >
                {obj.name}
              </p>
              <div
