...
import { Facebook, Footer_c, Linkden, Twiter } from "../Commonsvg/icon";

const Footer = () => {
  return (
    <div>
      <div className="bg-[url('../src/Assets/images/footer-bg.png')] bg-no-repeat object-cover bg-100% ]">
        <div className="max-w-[1200px] px-3 mx-auto sm:pt-[50px] ">
          <div className="flex flex-row  justify-center flex-wrap  -mx-3 pb-[40px] pt-5 md:pt-[50px]">
            <div className=" md:w-5/12 w-full px-3">
              ...
              <p className="font-ff-mon text-base md:max-w-[300px] font-normal pb-6 leading-[24px] not-italic text-[#A7A7A7] mb-0">
            ...
            <div className=" md:w-7/12 w-full px-3 pt-5 md:pt-0">
          ...
          <hr className="w-full h-[3px] stroke-[#43ff64d9]" />
          <p className="text-[14px] flex items-center justify-center font-normal font-ff-mon text-[#FFF] tracking-[.28px] not-italic text-center pt-5 pb-5 sm:pt-[40px]  sm:pb-[30px]">
